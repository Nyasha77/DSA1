...
public client class LibraryAddBookResponseCaller {
...
public client class LibraryUpdateBookResponseCaller {
    private grpc:Caller caller;
...
public client class LibraryCreateUsersResponseCaller {
    private grpc:Caller caller;
