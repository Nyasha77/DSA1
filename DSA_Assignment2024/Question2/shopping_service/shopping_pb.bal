...
public client class ShoppingSystemSearchProductResponseCaller {
...
public client class ShoppingSystemListAvailableProductsCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendListAvailableProducts(ListAvailableProducts response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextListAvailableProducts(ContextListAvailableProducts response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class ShoppingSystemStringCaller {
    private grpc:Caller caller;
